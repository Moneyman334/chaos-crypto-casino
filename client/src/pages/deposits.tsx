...
const CASINO_WALLETS: WalletAddress[] = [
  {
    blockchain: "Bitcoin",
    symbol: "BTC",
  ...
  return (
    <div className="container mx-auto p-6 max-w-7xl">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h1 className="text-3xl font-bold" data-testid="text-deposits-title">Casino Deposits</h1>
          <p className="text-muted-foreground">Deposit crypto to your casino account</p>
        </div>
      </div>
                ...
                <CardContent>
                  <ol className="space-y-3 text-sm">
                    ...
                    <li className="flex gap-3">
                      ...
                      <span>Your casino balance will be credited automatically</span>
                    </li>
                  </ol>
                </CardContent>
              </Card>
