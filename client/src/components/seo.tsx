...
const defaultSEO = {
  title: "CryptoCasino - Provably Fair Blockchain Gaming & Instant Crypto Payouts",
  description: "Experience the future of fair gaming with provably fair cryptocurrency games, instant payouts, and transparent blockchain verification. Play slots, poker, dice and more with ETH, BTC and other crypto.",
  keywords: ["crypto casino", "blockchain gambling", "provably fair gaming", "crypto slots", "bitcoin casino", "ethereum gambling", "cryptocurrency games", "instant crypto payouts", "decentralized casino", "web3 gaming", "crypto poker", "blockchain verification"],
...
export default function SEO({
  ...
  const fullTitle = useMemo(() => {
    return title ? `${title} | CryptoCasino` : defaultSEO.title;
  }, [title]);
